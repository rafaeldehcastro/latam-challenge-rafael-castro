...
class TestModel(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.data = pd.read_csv(filepath_or_buffer="/Users/radaedhecastro/Documents/latam-challenge-rafael-castro/data/data.csv")
    ...
    def test_model_predict(
        ...
        # Fit the model with the features and target data
        self.model.fit(
            features=features,
            target=target
        )
